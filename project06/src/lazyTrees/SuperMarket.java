 ...
 *
 * @author Foothill College, Kenneth Wu
 */
public class SuperMarket
{
	...
	private static final int GARBAGE_COLLECTION_THRESHOLD = 5;
	...
	public static void main(String[] args)
	{
		...
		final String TESTFILE = "resources/inventory_threshold_five.txt";	// Directory path for plain-text file
